...
class Generic extends Connect {
    ...
    public function generateProfilePanels($edit = false) {
        ...
        while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) :
            ?><div class="tab-pane <?php if ($i === 0 && $edit) echo 'active';
            else echo 'fade'; ?>" id="usr-<?php echo $this->sanitize_title($row['section']); ?>">
                <fieldset>
    ...
    public function generateAccessLogs() {
        ...
        <?php endif; ?>
            ...
            public function generateToken() {
                ...
                if (empty($_SESSION['jigowatt']['token']))//echo 'ivanecv';
            ...
            public function definePaths() {
                ...
                if (!defined('phplogin_db_version'))
                    define('phplogin_db_version', 1212300);
                if (!defined('phplogin_version'))
                    define('phplogin_version', 3.21);
            }
